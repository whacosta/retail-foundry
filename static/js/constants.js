...
export const CAPTURE_RANGES = {
    'Supermercado': {
        'popular': { min: 18.0, max: 30.0 },
        'media': { min: 25.0, max: 35.0 },
        'alta': { min: 35.0, max: 45.0 }
    },
    'Discounters': {
        'popular': { min: 25.0, max: 40.0 },
        'media': { min: 15.0, max: 25.0 },
        'alta': { min: 8.0, max: 15.0 }
    },
    'Tradicional': {
        'popular': { min: 20.0, max: 35.0 },
        'media': { min: 12.0, max: 22.0 },
        'alta': { min: 5.0, max: 10.0 }
    },
    'Especializados': {
        'popular': { min: 5.0, max: 12.0 },
        'media': { min: 10.0, max: 18.0 },
        'alta': { min: 18.0, max: 30.0 }
    },
    'Otros': {
        'popular': { min: 2.0, max: 6.0 },
        'media': { min: 2.0, max: 6.0 },
        'alta': { min: 3.0, max: 8.0 }
    }
};
